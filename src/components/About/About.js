    ...
    <section id="about-me" className="my-5 intro">
      ...
      <div className="flex-row">
        <div className="intro-info">
          ...
          I hold a Bachelor of Science degree in Information Technology from the University of Mount Kenya, which I completed in 2015. Additionally, I have completed the Willis College Cyber Security Analyst Diploma in 2021, 
